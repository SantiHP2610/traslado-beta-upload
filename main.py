...
_TEST_CASES = [
    {"filename": "evento_prueba.xlsx",        "label": "Caso: Estándar"},
    {"filename": "caso_caba_pool_grande.xlsx", "label": "Caso: CABA pool grande — con auto (12)"},
    {"filename": "caso_charter_real.xlsx",     "label": "Caso: Charter — sin auto (12)"},
    {"filename": "caso_sin_auto.xlsx",         "label": "Caso: Sin auto propio (10)"},
    {"filename": "caso_pe_norte.xlsx",         "label": "Caso: PE Norte — Olivos"},
    {"filename": "caso_pe_sur.xlsx",           "label": "Caso: PE Sur — Lanús"},
    {"filename": "caso_equipo_chico.xlsx",     "label": "Caso: Equipo chico (5)"},
    {"filename": "caso_random_1.xlsx",         "label": "Caso: Random 1"},
    {"filename": "caso_random_2.xlsx",         "label": "Caso: Random 2"},
]
